...
(cl:defclass <ArmorDirectiveRes> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (sparql_queried_objects
    ...
    :type (cl:vector injected_armor_msgs-msg:QueryItem)
   :initform (cl:make-array 0 :element-type 'injected_armor_msgs-msg:QueryItem :initial-element (cl:make-instance 'injected_armor_msgs-msg:QueryItem))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDirectiveRes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDirectiveRes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name injected_armor_msgs-msg:<ArmorDirectiveRes> is deprecated: use injected_armor_msgs-msg:ArmorDirectiveRes instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:success-val is deprecated.  Use injected_armor_msgs-msg:success instead.")
  (success m))

(cl:ensure-generic-function 'timeout-val :lambda-list '(m))
(cl:defmethod timeout-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:timeout-val is deprecated.  Use injected_armor_msgs-msg:timeout instead.")
  (timeout m))

(cl:ensure-generic-function 'exit_code-val :lambda-list '(m))
(cl:defmethod exit_code-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:exit_code-val is deprecated.  Use injected_armor_msgs-msg:exit_code instead.")
  (exit_code m))

(cl:ensure-generic-function 'error_description-val :lambda-list '(m))
(cl:defmethod error_description-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:error_description-val is deprecated.  Use injected_armor_msgs-msg:error_description instead.")
  (error_description m))

(cl:ensure-generic-function 'is_consistent-val :lambda-list '(m))
(cl:defmethod is_consistent-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:is_consistent-val is deprecated.  Use injected_armor_msgs-msg:is_consistent instead.")
  (is_consistent m))

(cl:ensure-generic-function 'queried_objects-val :lambda-list '(m))
(cl:defmethod queried_objects-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:queried_objects-val is deprecated.  Use injected_armor_msgs-msg:queried_objects instead.")
  (queried_objects m))
...
(cl:defmethod sparql_queried_objects-val ((m <ArmorDirectiveRes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-msg:sparql_queried_objects-val is deprecated.  Use injected_armor_msgs-msg:sparql_queried_objects instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmorDirectiveRes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'sparql_queried_objects)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'injected_armor_msgs-msg:QueryItem))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorDirectiveRes>)))
  ...
  (cl:format cl:nil "bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorDirectiveRes)))
  "Returns full string definition for message of type 'ArmorDirectiveRes"
  (cl:format cl:nil "bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
