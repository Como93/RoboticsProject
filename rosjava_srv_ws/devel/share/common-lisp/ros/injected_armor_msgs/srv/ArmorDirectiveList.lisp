...
(cl:defclass <ArmorDirectiveList-request> (roslisp-msg-protocol:ros-message)
  ((armor_requests
    ...
    :type (cl:vector injected_armor_msgs-msg:ArmorDirectiveReq)
   :initform (cl:make-array 0 :element-type 'injected_armor_msgs-msg:ArmorDirectiveReq :initial-element (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveReq))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDirectiveList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDirectiveList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name injected_armor_msgs-srv:<ArmorDirectiveList-request> is deprecated: use injected_armor_msgs-srv:ArmorDirectiveList-request instead.")))

(cl:ensure-generic-function 'armor_requests-val :lambda-list '(m))
(cl:defmethod armor_requests-val ((m <ArmorDirectiveList-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:armor_requests-val is deprecated.  Use injected_armor_msgs-srv:armor_requests instead.")
  (armor_requests m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmorDirectiveList-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'armor_requests)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveReq))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDirectiveList-request>)))
  ...
  "injected_armor_msgs/ArmorDirectiveListRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirectiveList-request)))
  "Returns string type for a service object of type 'ArmorDirectiveList-request"
  "injected_armor_msgs/ArmorDirectiveListRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorDirectiveList-request>)))
  ...
  (cl:format cl:nil "ArmorDirectiveReq[] armor_requests~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveReq~%string client_name~%string reference_name~%string command~%string primary_command_spec~%string secondary_command_spec~%string[] args~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorDirectiveList-request)))
  "Returns full string definition for message of type 'ArmorDirectiveList-request"
  (cl:format cl:nil "ArmorDirectiveReq[] armor_requests~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveReq~%string client_name~%string reference_name~%string command~%string primary_command_spec~%string secondary_command_spec~%string[] args~%~%"))
...
(cl:defclass <ArmorDirectiveList-response> (roslisp-msg-protocol:ros-message)
  ((success
   ...
   (armor_responses
    ...
    :type (cl:vector injected_armor_msgs-msg:ArmorDirectiveRes)
   :initform (cl:make-array 0 :element-type 'injected_armor_msgs-msg:ArmorDirectiveRes :initial-element (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveRes))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDirectiveList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDirectiveList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name injected_armor_msgs-srv:<ArmorDirectiveList-response> is deprecated: use injected_armor_msgs-srv:ArmorDirectiveList-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ArmorDirectiveList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:success-val is deprecated.  Use injected_armor_msgs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'is_consistent-val :lambda-list '(m))
(cl:defmethod is_consistent-val ((m <ArmorDirectiveList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:is_consistent-val is deprecated.  Use injected_armor_msgs-srv:is_consistent instead.")
  (is_consistent m))
...
(cl:defmethod armor_responses-val ((m <ArmorDirectiveList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:armor_responses-val is deprecated.  Use injected_armor_msgs-srv:armor_responses instead.")
  (armor_responses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArmorDirectiveList-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'armor_responses)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveRes))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDirectiveList-response>)))
  ...
  "injected_armor_msgs/ArmorDirectiveListResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirectiveList-response)))
  "Returns string type for a service object of type 'ArmorDirectiveList-response"
  "injected_armor_msgs/ArmorDirectiveListResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorDirectiveList-response>)))
  ...
  (cl:format cl:nil "bool success~%bool is_consistent~%ArmorDirectiveRes[] armor_responses~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveRes~%bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorDirectiveList-response)))
  "Returns full string definition for message of type 'ArmorDirectiveList-response"
  (cl:format cl:nil "bool success~%bool is_consistent~%ArmorDirectiveRes[] armor_responses~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveRes~%bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirectiveList)))
  ...
  "injected_armor_msgs/ArmorDirectiveList")