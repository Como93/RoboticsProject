...
(cl:defclass <ArmorDirective-request> (roslisp-msg-protocol:ros-message)
  ((armor_request
    ...
    :type injected_armor_msgs-msg:ArmorDirectiveReq
    :initform (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveReq)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDirective-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDirective-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name injected_armor_msgs-srv:<ArmorDirective-request> is deprecated: use injected_armor_msgs-srv:ArmorDirective-request instead.")))

(cl:ensure-generic-function 'armor_request-val :lambda-list '(m))
(cl:defmethod armor_request-val ((m <ArmorDirective-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:armor_request-val is deprecated.  Use injected_armor_msgs-srv:armor_request instead.")
  (armor_request m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDirective-request>)))
  ...
  "injected_armor_msgs/ArmorDirectiveRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirective-request)))
  "Returns string type for a service object of type 'ArmorDirective-request"
  "injected_armor_msgs/ArmorDirectiveRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorDirective-request>)))
  ...
  (cl:format cl:nil "ArmorDirectiveReq armor_request~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveReq~%string client_name~%string reference_name~%string command~%string primary_command_spec~%string secondary_command_spec~%string[] args~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorDirective-request)))
  "Returns full string definition for message of type 'ArmorDirective-request"
  (cl:format cl:nil "ArmorDirectiveReq armor_request~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveReq~%string client_name~%string reference_name~%string command~%string primary_command_spec~%string secondary_command_spec~%string[] args~%~%"))
...
(cl:defclass <ArmorDirective-response> (roslisp-msg-protocol:ros-message)
  ((armor_response
    ...
    :type injected_armor_msgs-msg:ArmorDirectiveRes
    :initform (cl:make-instance 'injected_armor_msgs-msg:ArmorDirectiveRes)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDirective-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDirective-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name injected_armor_msgs-srv:<ArmorDirective-response> is deprecated: use injected_armor_msgs-srv:ArmorDirective-response instead.")))

(cl:ensure-generic-function 'armor_response-val :lambda-list '(m))
(cl:defmethod armor_response-val ((m <ArmorDirective-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader injected_armor_msgs-srv:armor_response-val is deprecated.  Use injected_armor_msgs-srv:armor_response instead.")
  (armor_response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDirective-response>)))
  ...
  "injected_armor_msgs/ArmorDirectiveResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirective-response)))
  "Returns string type for a service object of type 'ArmorDirective-response"
  "injected_armor_msgs/ArmorDirectiveResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArmorDirective-response>)))
  ...
  (cl:format cl:nil "ArmorDirectiveRes armor_response~%~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveRes~%bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArmorDirective-response)))
  "Returns full string definition for message of type 'ArmorDirective-response"
  (cl:format cl:nil "ArmorDirectiveRes armor_response~%~%~%================================================================================~%MSG: injected_armor_msgs/ArmorDirectiveRes~%bool success~%bool timeout~%int32 exit_code~%string error_description~%bool is_consistent~%string[] queried_objects~%QueryItem[] sparql_queried_objects~%================================================================================~%MSG: injected_armor_msgs/QueryItem~%string key~%string value~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDirective)))
  ...
  "injected_armor_msgs/ArmorDirective")