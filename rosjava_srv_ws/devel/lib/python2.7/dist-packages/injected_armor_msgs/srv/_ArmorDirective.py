...
"""autogenerated by genpy from injected_armor_msgs/ArmorDirectiveRequest.msg. Do not edit."""
import sys
...
class ArmorDirectiveRequest(genpy.Message):
  ...
  _type = "injected_armor_msgs/ArmorDirectiveRequest"
...
string[] args"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.armor_request is None:
        self.armor_request = injected_armor_msgs.msg.ArmorDirectiveReq()
    else:
      self.armor_request = injected_armor_msgs.msg.ArmorDirectiveReq()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.armor_request.client_name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.armor_request.reference_name = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.armor_request.command = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.armor_request.primary_command_spec = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.armor_request.secondary_command_spec = str[start:end].decode('utf-8')
      else:
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from injected_armor_msgs/ArmorDirectiveResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ArmorDirectiveResponse(genpy.Message):
  ...
  _type = "injected_armor_msgs/ArmorDirectiveResponse"
  _has_header = False #flag to mark the presence of a Header object
...
string value"""
  ...
  _slot_types = ['injected_armor_msgs/ArmorDirectiveRes']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.armor_response is None:
        self.armor_response = injected_armor_msgs.msg.ArmorDirectiveRes()
    else:
      self.armor_response = injected_armor_msgs.msg.ArmorDirectiveRes()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.armor_response.is_consistent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.armor_response.error_description = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        val1 = injected_armor_msgs.msg.QueryItem()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
class ArmorDirective(object):
  _type          = 'injected_armor_msgs/ArmorDirective'
