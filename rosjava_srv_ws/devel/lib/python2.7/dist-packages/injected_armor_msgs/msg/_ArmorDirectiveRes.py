...
"""autogenerated by genpy from injected_armor_msgs/ArmorDirectiveRes.msg. Do not edit."""
import sys
...
class ArmorDirectiveRes(genpy.Message):
  ...
  _type = "injected_armor_msgs/ArmorDirectiveRes"
...
string value"""
  ...
  _slot_types = ['bool','bool','int32','string','bool','string[]','injected_armor_msgs/QueryItem[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.is_consistent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.error_description = str[start:end].decode('utf-8')
      else:
